 ...
 */
package com.papa.jee18.web.jsfhelper.util;
...
public class LocalDateFacesConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object modelValue) {
        ...
        if (modelValue instanceof LocalDate) {
            ...
            return getFormatter(context, component).format(ZonedDateTime.of((LocalDate)modelValue, LocalTime.MIN, ZoneOffset.UTC));
        } else {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        ...
        try {
            return ZonedDateTime.parse(submittedValue, getFormatter(context, component)).withZoneSameInstant(ZoneOffset.UTC).toLocalDate();
